        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn>
            <div className="flex flex-col items-center gap-3">
              ...
              <h3 className="font-semibold text-[#92400e]">Une approche non divinatoire</h3>
              <p className="text-[#92400e]/80 max-w-2xl">
                Le psycho-tarot et la guidance que je propose ne sont <strong>pas des lectures divinatoires</strong>.
                Les cartes sont utilisées comme un outil d&apos;introspection et d&apos;accompagnement,
                pour explorer votre monde intérieur et identifier vos ressources — jamais pour prédire l&apos;avenir.
              </p>
            </div>
          </FadeIn>
        </div>
